    ...
    def send_clipboard():
        ...
        if content:
            ...
            if response.status_code == 204:
                messagebox.showinfo("Erfolg", "Clipboard-Inhalt wurde gesendet.")
            else:
                messagebox.showerror("Fehler", f"Fehler beim Senden: {response.status_code}")
        else:
            messagebox.showwarning("Leer", "Zwischenablage ist leer!")
